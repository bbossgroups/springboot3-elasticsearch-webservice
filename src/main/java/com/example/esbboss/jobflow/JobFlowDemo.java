package com.example.esbboss.jobflow;
/**
...
public class JobFlowDemo {
    private static Logger logger = LoggerFactory.getLogger(JobFlowDemo.class);
...
//        });
        ...
        parrelnewNodeTrigger.setTriggerScriptAPI(new TriggerScriptAPI() {
            ...
            public boolean needTrigger(NodeTriggerContext nodeTriggerContext) throws Exception {
                return enableParrelNode != null && enableParrelNode.equals(true);
            }
        });
